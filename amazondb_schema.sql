...
CREATE TABLE `product_variants` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `product_variants_product_id_color_storage_b1e79b82_uniq` (`product_id`,`color`,`storage`),
  CONSTRAINT `product_variants_product_id_019d9f04_fk_products_productid` FOREIGN KEY (`product_id`) REFERENCES `products` (`productid`),
...
CREATE TABLE `refund` (
  ...
  CONSTRAINT `refund_ibfk_2` FOREIGN KEY (`productid`) REFERENCES `products` (`productid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sale` (
  ...
  PRIMARY KEY (`saleid`),
  KEY `productId` (`productId`),
  CONSTRAINT `sale_ibfk_1` FOREIGN KEY (`productId`) REFERENCES `products` (`productid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-07-07 17:28:44
